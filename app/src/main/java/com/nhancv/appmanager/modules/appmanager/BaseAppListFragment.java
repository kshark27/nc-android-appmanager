...
import com.nhancv.appmanager.utils.SortHelper;
import com.nhancv.appmanager.views.CustomRecyclerView;
...
public abstract class BaseAppListFragment extends Fragment implements SearchView.OnQueryTextListener, SearchView.OnCloseListener, View.OnClickListener {
    ...
    private class LoadApps extends AsyncTask<Void, Void, ArrayList<AppItem>> {
        ...
        @DebugLog
        @Nullable
        private List<PackageInfo> getInstalledPackages(PackageManager pm) {
            try {
        ...
        @DebugLog
        @NonNull
        private List<PackageInfo> getInstalledPackagesShell(PackageManager pm) {
            final List<PackageInfo> pkgInfos = new ArrayList<>();
        ...
        @Override
        protected void onPostExecute(final ArrayList<AppItem> appItems) {
