...
package com.nhancv.appmanager.preference;
...
public class PreferenceManagerCompat {
    ...
    /**
     * Sets the owning com.nhancv.appmanager.externalsources.preference fragment
     */
    ...
    /**
     * Inflates a com.nhancv.appmanager.externalsources.preference hierarchy from the com.nhancv.appmanager.externalsources.preference hierarchies of
     * {@link Activity Activities} that match the given {@link Intent}. An
     * {@link Activity} defines its com.nhancv.appmanager.externalsources.preference hierarchy with meta-data using
     * the {@link #METADATA_KEY_PREFERENCES} key.
     * <p/>
     * If a com.nhancv.appmanager.externalsources.preference hierarchy is given, the new com.nhancv.appmanager.externalsources.preference hierarchies will
     * be merged in.
     *
    ...
    /**
     * Inflates a com.nhancv.appmanager.externalsources.preference hierarchy from XML. If a com.nhancv.appmanager.externalsources.preference hierarchy is
     * given, the new com.nhancv.appmanager.externalsources.preference hierarchies will be merged in.
     *
    ...
    /**
     * Returns the root of the com.nhancv.appmanager.externalsources.preference hierarchy managed by this class.
     *
    ...
    /**
     * Sets the root of the com.nhancv.appmanager.externalsources.preference hierarchy.
     *
     * @param preferenceScreen The root {@link PreferenceScreen} of the com.nhancv.appmanager.externalsources.preference hierarchy.
    ...
    interface OnPreferenceTreeClickListener {
        /**
         * Called when a com.nhancv.appmanager.externalsources.preference in the tree rooted at this
         * {@link PreferenceScreen} has been clicked.
         *
         * @param preferenceScreen The {@link PreferenceScreen} that the
         *                         com.nhancv.appmanager.externalsources.preference is located in.
         * @param preference       The com.nhancv.appmanager.externalsources.preference that was clicked.
