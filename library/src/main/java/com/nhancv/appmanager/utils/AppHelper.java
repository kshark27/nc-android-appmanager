...
import com.nhancv.appmanager.modules.appmanager.PackageStatsObserver;
...
import static com.nhancv.appmanager.models.DeviceConstants.ID_PGREP;
...
public class AppHelper {
     ...
     */
    public static void getProcess(final ShellOutput.OnShellOutputListener listener, final String process) {
